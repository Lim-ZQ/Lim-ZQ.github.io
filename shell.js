...
const PAGES = {
  index: () => [
    ...
    "Hong Kong SAR, China",
    "",
    `> ${osc("about", "#about")} · ${osc("papers", "#papers")} · ${osc("experience", "#experience")} · ${osc("teaching", "#teaching")}`,
    ...
    `${osc("Prof. Irwin King", "https://www.cse.cuhk.edu.hk/people/faculty/irwin-king/")}. My research focuses on RNA`,
    "structure prediction and design, diffusion models for biomolecule generation,",
    "and biomolecule interactions.",
    "",
    "• This page doubles as a shell.",
    `  Try: ${C.path}help${C.reset}, ${C.path}papers${C.reset}, ${C.path}ls${C.reset}.`,
    "",
    `${C.dim}Last update: Thu Sep 3 2026${C.reset}`,
  ],
  about: () => [
    ...
    "",
    "My research focuses on RNA structure prediction and design, diffusion models",
    "for biomolecule generation, and biomolecule interactions.",
    "",
  ...
  interests: () => [
    ...
    "• Diffusion models for biomolecule generation",
